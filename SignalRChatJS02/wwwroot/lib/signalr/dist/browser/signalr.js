...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory() :  // node.JS环境(CommonJS规范,同步加载，一般服务器端用): 定义模块用module.exports, 使用模块需要require关键字
	typeof define === 'function' && define.amd ? define(factory) :  // 如: RequireJS环境(AMD规范，异步加载，一般浏览器端用); 又如seaJS(CMD规范): 定义模块用 define关键字，使用模块需要require关键字
	(global.signalR = factory());   // 非CommonJS规范、非CMD规范，也非AMD规范，则有可能是ES6的import export
